  ...
  return (
    <footer className="border-t border-slate-200 bg-white">
      ...
      <div className="border-t border-slate-200">
        <div className="container-page flex flex-col sm:flex-row items-center justify-between gap-3 py-5 text-xs text-slate-500">
    ...
    <div>
      ...
      <ul className="mt-3 space-y-2">
        {links.map(([label, href]) => (
          <li key={label}>
            <a href={href} className="text-sm text-slate-600 hover:text-brand-700">
              {label}
            </a>
          </li>
        ))}
