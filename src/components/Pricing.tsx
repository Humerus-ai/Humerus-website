          ...
          return (
            <div
              ...
              className={`relative rounded-2xl border p-6 flex flex-col text-left transition ${
                t.highlighted
                  ? 'border-brand-500 bg-brand-50/40 shadow-card-hover'
            ...
            >
              ...
              <div className="flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-white text-brand-600 shadow-card">
                  <Icon className="h-5 w-5" />
                </div>
                <div>
                  <div className="text-base font-semibold text-slate-900">{t.name}</div>
                  <div className="text-xs text-slate-500">{t.vertical}</div>
                </div>
              </div>
